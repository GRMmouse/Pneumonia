...
for l_idx =1:length(params)
    grad_newW = param_grad{l_idx}.w + weight_decay*params{l_idx}.w;
    grad_newB = param_grad{l_idx}.b;
    param_winc{l_idx}.w = mu*param_winc{l_idx}.w+ rate*grad_newW;
    param_winc{l_idx}.b = mu*param_winc{l_idx}.b+ rate*grad_newB;
